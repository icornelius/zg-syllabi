...
<!-- Required books are available at the campus bookstore -->
``` {.include}
partials/policies-0021-20260802163125.md
```
> Cannon, Christopher, and James Simpson, eds. *The Oxford Chaucer*. Oxford University Press, 2025.
\[ISBN 978-0-19-898718-5\]
...
``` {.include}
partials/policies-0006-20220818162916.md
```

## Privacy

<!-- Audio recordings only by permission of SAC -->
``` {.include}
partials/policies-0005-20220818161952.md
```
...
<!-- CC0 public domain designation for the syllabus -->
``` {.include}
partials/misc-0004-20260802174137.md
```

<!-- Copyright warning for course readings -->
``` {.include}
