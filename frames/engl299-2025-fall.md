...
## Course details
``` {.include}
course_id-0010-20250413114604.md
```
...
``` {.include}
course_desc-0010-20250318222122.md
outcome-0004-20250725154550.md
```

# Texts
``` {.include}
texts-0006-20250725155705.md
```
...
``` {.include}
schedule-0009-20250725161726.md
...
[View file history on GitHub](https://github.com/icornelius/zg-syllabi/commits/main/build/engl320-2025-fall.md)
...
These details are available on [Zotero](https://www.zotero.org/irc7/collections/ANEIPCFP) in machine-readable formats.
