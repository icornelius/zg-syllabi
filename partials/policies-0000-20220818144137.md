...
This course makes special provision for absences due to religious observances (see [Uniform Policies](#uniform-policies)) or illness (see [Public Health](#public-health)).
